...
let countDown = new Date(`${config.birthdate} 10:00:00`).getTime();
x = setInterval(function() {
  let now = new Date().getTime(),
    distance = countDown - now;

  document.getElementById('25').innerText = Math.floor(distance / day);
  document.getElementById('9').innerText = Math.floor(
    (distance % day) / hour
  );
  document.getElementById('54').innerText = Math.floor(
    (distance % hour) / minute
  );
  document.getElementById('45').innerText = Math.floor(
